                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $query = "SELECT COUNT(*) AS total_users FROM tb_account WHERE role = 'user'";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php 
                                                $query = "SELECT COUNT(*) AS total_users FROM tb_account WHERE role = 'admin'";
                                                $result = $connection->query($query);
                                                
                                                if ($result) {
                                                    if ($row = $result->fetch_assoc()) {
                                                        $total_users = $row['total_users'];
                                                        echo "Total admin : $total_users";
                                                    } else {
                                                        echo "No users found with role 'user'.";
                                                    }
                                                } else {
